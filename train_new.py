...
if __name__ == '__main__':
    ...
    dataset_paired = create_dataset(opt)  # create a dataset given opt.dataset_mode and other options
    ...
    dataset_unpaired = create_dataset(opt)  # create a dataset given opt.dataset_mode and other options
